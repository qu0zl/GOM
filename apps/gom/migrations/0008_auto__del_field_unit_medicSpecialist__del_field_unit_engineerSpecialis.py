...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Unit.medicSpecialist'
        db.delete_column('gom_unit', 'medicSpecialist')

        # Deleting field 'Unit.engineerSpecialist'
        db.delete_column('gom_unit', 'engineerSpecialist')


    def backwards(self, orm):
        # Adding field 'Unit.medicSpecialist'
        db.add_column('gom_unit', 'medicSpecialist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unit.engineerSpecialist'
        db.add_column('gom_unit', 'engineerSpecialist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
