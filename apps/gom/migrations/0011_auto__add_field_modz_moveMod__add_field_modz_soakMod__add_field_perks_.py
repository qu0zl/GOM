...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Modz.moveMod'
        db.add_column('gom_modz', 'moveMod',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Modz.soakMod'
        db.add_column('gom_modz', 'soakMod',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Perks.moveMod'
        db.add_column('gom_perks', 'moveMod',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Perks.soakMod'
        db.add_column('gom_perks', 'soakMod',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Modz.moveMod'
        db.delete_column('gom_modz', 'moveMod')

        # Deleting field 'Modz.soakMod'
        db.delete_column('gom_modz', 'soakMod')

        # Deleting field 'Perks.moveMod'
        db.delete_column('gom_perks', 'moveMod')

        # Deleting field 'Perks.soakMod'
        db.delete_column('gom_perks', 'soakMod')
