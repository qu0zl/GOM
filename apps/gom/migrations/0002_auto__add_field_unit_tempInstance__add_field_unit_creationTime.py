...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.tempInstance'
        db.add_column('gom_unit', 'tempInstance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Unit.creationTime'
        db.add_column('gom_unit', 'creationTime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.tempInstance'
        db.delete_column('gom_unit', 'tempInstance')

        # Deleting field 'Unit.creationTime'
        db.delete_column('gom_unit', 'creationTime')
