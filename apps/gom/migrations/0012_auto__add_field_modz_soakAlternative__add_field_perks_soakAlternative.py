...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Modz.soakAlternative'
        db.add_column('gom_modz', 'soakAlternative',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Perks.soakAlternative'
        db.add_column('gom_perks', 'soakAlternative',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Modz.soakAlternative'
        db.delete_column('gom_modz', 'soakAlternative')

        # Deleting field 'Perks.soakAlternative'
        db.delete_column('gom_perks', 'soakAlternative')
