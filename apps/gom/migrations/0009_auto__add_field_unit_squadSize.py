...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.squadSize'
        db.add_column('gom_unit', 'squadSize',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.squadSize'
        db.delete_column('gom_unit', 'squadSize')
